...
\renewcommand{\stamptime}{2026-09-07 11:57 PDT}
\renewcommand{\stampversion}{\detokenize{d3db1ea-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
template (\texttt{R/simulation.R}) for extending the comparison to
...
\item
  ...
  clustering in\textsuperscript{\citeproc{ref-winkensOptimalTimepointsClinical2005}{1}}; Section
...
of the finding more broadly. \texttt{R/simulation.R} in the accompanying
...
\texttt{analytic\_gls\_se\_general()} in \texttt{R/covariance.R}, which generalizes
...
\subsection{Scenario extension (Monte Carlo)}\label{scenario-extension-monte-carlo}
...
23, 24). For each of the resulting 20 cells, \texttt{run\_one\_sim()} (for
the random-slope structures) or \texttt{run\_one\_sim\_cov()} (for compound
symmetry and AR(1) plus error, fitting \texttt{nlme::gls()} with a
matched correlation structure) is used to fit
1000 simulated replications under REML, exactly as
...
count per cell (1000) is reduced from the main
comparison's 2000 to keep the 20-cell grid within a
practical single-core runtime. The completed grid took
37
minutes. \texttt{Rscript\ analysis/scripts/run\_full\_factorial.R}
regenerates Table \ref{tab:factorial-grid}.

\begin{table}[!h]
\centering
\caption{\label{tab:factorial-grid}Monte Carlo relative efficiency of each visit schedule versus equal spacing, by covariance structure, at 1000 replications per cell.}
\centering
...
\midrule
Random slope & tau\_1 = 0.10 & Equal & 0.999 & 0.0382 & 1.00\\
Random slope & tau\_1 = 0.10 & Mild-clustered & 0.999 & 0.0347 & 1.21\\
Random slope & tau\_1 = 0.10 & Boundary-clustered & 1.000 & 0.0324 & 1.39\\
Random slope & tau\_1 = 0.10 & Extreme-clustered & 1.000 & 0.0302 & 1.59\\
Random slope & tau\_1 = 0.30 & Equal & 0.811 & 0.0671 & 1.00\\
\addlinespace
Random slope & tau\_1 = 0.30 & Mild-clustered & 0.787 & 0.0665 & 1.02\\
Random slope & tau\_1 = 0.30 & Boundary-clustered & 0.823 & 0.0658 & 1.04\\
Random slope & tau\_1 = 0.30 & Extreme-clustered & 0.805 & 0.0656 & 1.04\\
Random slope & tau\_1 = 0.50 & Equal & 0.423 & 0.1032 & 1.00\\
Random slope & tau\_1 = 0.50 & Mild-clustered & 0.445 & 0.1013 & 1.04\\
\addlinespace
Random slope & tau\_1 = 0.50 & Boundary-clustered & 0.437 & 0.1070 & 0.93\\
Random slope & tau\_1 = 0.50 & Extreme-clustered & 0.463 & 0.1008 & 1.05\\
Compound symmetry & tau\_0 = 5.0 & Equal & 1.000 & 0.0319 & 1.00\\
Compound symmetry & tau\_0 = 5.0 & Mild-clustered & 1.000 & 0.0288 & 1.22\\
Compound symmetry & tau\_0 = 5.0 & Boundary-clustered & 1.000 & 0.0272 & 1.38\\
\addlinespace
Compound symmetry & tau\_0 = 5.0 & Extreme-clustered & 1.000 & 0.0251 & 1.62\\
...
(relative efficiency up to 1.62 for extreme
...
empirical SE (0.1070) is slightly
\emph{larger} than equal spacing's (0.1032,
relative efficiency 0.93). Given
...
1.17 vs.
1.24), plausibly because packing
...
All 20 cells converged fully (1000/
1000 replications at minimum). Estimated bias is
...
\item
  ...
  substantially reduce the Monte Carlo error of the \emph{difference}
...
\texttt{analysis/data/derived\_data/sim\_results.rds}. This document reads
...
(ratio of empirical variances) is 1.07
(95\% bootstrap interval 1.06 to
...
effect;\textsuperscript{\citeproc{ref-winkens2007polynomial}{8}} showed that optimal designs differ
...
investigated. The maximin D-optimal framework of\textsuperscript{\citeproc{ref-ouwens2002maximin}{4}} and the Bayesian approach of\textsuperscript{\citeproc{ref-abebe2014bayesian}{10}}
