...
\renewcommand{\stampversion}{\detokenize{ea19a49}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
\tightlist
\item
  Generate 100 subjects, randomized 1:1 to treatment
  and control.
\item
  Simulate longitudinal outcomes at the five visit times for each
...
power of 100.0\%, compared
with 100.0\% for the
clustered design. The empirical standard error of
\(\hat{\beta}_3\) is 0.0671 under equal
spacing and 0.0650 under the clustered
design.
