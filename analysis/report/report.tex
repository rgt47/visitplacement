...
\renewcommand{\stamptime}{2026-08-20 17:55 PDT}
\renewcommand{\stampversion}{\detokenize{6f48a5e-wip}}
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{booktabs}
...
direction of the finding more broadly. \texttt{R/simulation.R} in the
...
per cell (1000) is reduced from the main
comparison's 2000 to keep the 20-cell grid within a practical
...
1.62 for extreme clustering), consistent
...
(0.1070) is slightly \emph{larger} than
equal spacing's (0.1032, relative
efficiency 0.93); given each
